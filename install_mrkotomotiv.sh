...
# MrkTahsilatWeb Hızlı Kurulum Scripti - mrkotomotiv.com
...
PROJECT_DIR="/var/www/mrkotomotiv"
...
REACT_APP_API_URL=https://mrkotomotiv.com/api
...
echo "🌍 Site: http://mrkotomotiv.com"
echo "📊 API Health: http://mrkotomotiv.com/api/health"
